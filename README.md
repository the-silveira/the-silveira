...
[![GitHub WidgetBox](https://github-widgetbox.vercel.app/api/skills?includeNames=true&theme=darkmode&languages=html,css,js,ts,php,c,cpp,csharp,dart,python,bash,xml,json,mysql,powershell,visualbasic,x86,arm&frameworks=flutter,angular,dotnetcore,dotnet)](https://github.com/Jurredr/github-widgetbox)
